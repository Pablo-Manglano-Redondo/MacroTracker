  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      {isLoading ? (
        ...
        <div className="portal-panel flex min-h-[340px] flex-col items-center justify-center rounded-[1.6rem] p-12 text-center">
      ...
      {showForm &&
        createPortal(
          ...
          >
            <div
              className="glass-card my-auto w-full max-w-2xl rounded-[1.8rem] p-8"
