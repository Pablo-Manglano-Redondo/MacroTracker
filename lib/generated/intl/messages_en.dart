...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m38(date) => "Last plan sync: ${date}";

  static String m39(kcal) => "${kcal} kcal today";

  static String m40(count) => "${count} pending";

  static String m41(count) => "Messages (${count})";

  static String m42(date) => "Consent active since ${date}.";
  ...
  static String m44(percent) => "Estimated adherence: ${percent}%";

  static String m45(phase) => "Current phase: ${phase}";

  static String m46(recipe, slot) => "${recipe} added to ${slot}";
  ...
  static String m49(name) => "${name} added";

  static String m50(count) => "${count} times";

  static String m51(count) => "${count} ingredients";

  static String m52(count) => "${count} servings";

  static String m53(count) => "Photo calls: ${count}";

  static String m54(count) => "Text calls: ${count}";

  static String m55(count) => "Total calls: ${count}";

  static String m56(cost) => "This month: ${cost}";

  static String m57(cost) => "Today: ${cost}";

  static String m58(cost) => "Total estimated: ${cost}";

  static String m59(kcal) => "Daily adjustment updated to ${kcal} kcal.";

  static String m60(delta) => "Apply ${delta} kcal/day";

  static String m61(kcal) => "Current adjustment: ${kcal} kcal.";

  static String m62(percent) => "${percent}% of registered days";

  static String m63(count) => "${count} days registered this week";

  static String m64(delta) => "Weight trend: ${delta} kg/week";

  static String m65(age) => "${age} years";
