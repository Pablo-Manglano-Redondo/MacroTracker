...
class MealInterpretationRemoteDataSource {
  ...
  Future<InterpretationDraftEntity> mapDraftResponse(dynamic data,
    ...
    return InterpretationDraftEntity(
      ...
      totalSodium: _toDoubleNullable(totals['sodium']),
      totalPotassium: _toDoubleNullable(totals['potassium']),
      totalCalcium: _toDoubleNullable(totals['calcium']),
      totalIron: _toDoubleNullable(totals['iron']),
      totalVitaminC: _toDoubleNullable(totals['vitaminC']),
      totalVitaminD: _toDoubleNullable(totals['vitaminD']),
      confidenceBand:
  ...
  InterpretationDraftItemEntity _mapItem(dynamic item, {required S copy}) {
    ...
    return InterpretationDraftItemEntity(
      ...
      sodium: _toDoubleNullable(item['sodium']),
      potassium: _toDoubleNullable(item['potassium']),
      calcium: _toDoubleNullable(item['calcium']),
      iron: _toDoubleNullable(item['iron']),
      vitaminC: _toDoubleNullable(item['vitaminC']),
      vitaminD: _toDoubleNullable(item['vitaminD']),
      novaGroup: _toIntNullable(item['novaGroup']),
      confidenceBand:
