...
void main() {
  group('PalCalc.getPALValueFromActivityCategory', () {
    UserEntity makeUser(UserPALEntity pal) => UserEntity(
    ...
    test('sedentary returns 1.25', () {
      expect(
          PalCalc.getPALValueFromActivityCategory(
              makeUser(UserPALEntity.sedentary)),
          1.25);
    });
    ...
    test('low active returns 1.5', () {
      expect(
          PalCalc.getPALValueFromActivityCategory(
              makeUser(UserPALEntity.lowActive)),
          1.5);
    });
    ...
    test('very active returns 2.2', () {
      expect(
          PalCalc.getPALValueFromActivityCategory(
              makeUser(UserPALEntity.veryActive)),
          2.2);
    });
  });

  group('PalCalc.getPAValueFromPALValue', () {
    UserEntity makeUser(UserPALEntity pal,
    ...
    test('PAL < 1.4 returns 1.0 regardless of gender', () {
      final male = makeUser(UserPALEntity.sedentary);
      final female =
          makeUser(UserPALEntity.sedentary, gender: UserGenderEntity.female);
    ...
    test('PAL 1.4-1.59 returns gender-specific values', () {
      final male = makeUser(UserPALEntity.lowActive);
      final female =
          makeUser(UserPALEntity.lowActive, gender: UserGenderEntity.female);
    ...
    test('PAL 1.6-1.89 returns 1.27 for both genders', () {
      final male = makeUser(UserPALEntity.active);
      final female =
          makeUser(UserPALEntity.active, gender: UserGenderEntity.female);
    ...
    test('PAL >= 1.9 returns gender-specific values', () {
      final male = makeUser(UserPALEntity.veryActive);
      final female =
          makeUser(UserPALEntity.veryActive, gender: UserGenderEntity.female);
